...
[![1. ASN.1 specification analysis.](/template/static/img/specs_asn.gif)](/template/static/img/specs_asn.gif "Click to see the full-resolution image")
...
[![2. DTD specification analysis.](/template/static/img/specs_dtd.gif)](/template/static/img/specs_dtd.gif "Click to see the full-resolution image")
...
[![3. Data values.](/template/static/img/data_types.gif)](/template/static/img/data_types.gif "Click to see the full-resolution image")
...
[![4. Code generation.](/template/static/img/type_strings.gif)](/template/static/img/type_strings.gif "Click to see the full-resolution image")
...
[![Image LoadBalancingLocal.jpg](/template/static/img/LoadBalancingLocal.jpg)](/template/static/img/LoadBalancingLocal.jpg "Click to see the full-resolution image")
...
[![Image LoadBalancingInternetShort.jpg](/template/static/img/LoadBalancingInternetShort.jpg)](/template/static/img/LoadBalancingInternetShort.jpg "Click to see the full-resolution image")
...
[![Image LoadBalancingInternetLong.jpg](/template/static/img/LoadBalancingInternetLong.jpg)](/template/static/img/LoadBalancingInternetLong.jpg "Click to see the full-resolution image")
...
[![Image LoadBalancingDispD.jpg](/template/static/img/LoadBalancingDispD.jpg)](/template/static/img/LoadBalancingDispD.jpg "Click to see the full-resolution image")
...
[![Image ch\_app\_lbsmd\_cfg\_structure.png](/template/static/img/ch_app_lbsmd_cfg_structure.png)](/template/static/img/ch_app_lbsmd_cfg_structure.png "Click to see the full-resolution image")
...
[![Image CFEngine.jpg](/template/static/img/CFEngine.jpg)](/template/static/img/CFEngine.jpg "Click to see the full-resolution image")
...
[![Image LBSMDSearchMain.gif](/template/static/img/LBSMDSearchMain.gif)](/template/static/img/LBSMDSearchMain.gif "Click to see the full-resolution image")
...
[![Image Penalty.jpg](/template/static/img/Penalty.jpg)](/template/static/img/Penalty.jpg "Click to see the full-resolution image")
...
[![Image lbsm\_feedback.gif](/template/static/img/lbsm_feedback.gif)](/template/static/img/lbsm_feedback.gif "Click to see the full-resolution image")
...
[![Image FWDaemonMonitor.gif](/template/static/img/FWDaemonMonitor.gif)](/template/static/img/FWDaemonMonitor.gif "Click to see the full-resolution image")

Figure 15. FWDaemon Checking Web Page

By clicking the “Check” button a page similar to the following will appear.

[![Image FWDaemonCheckPage.gif](/template/static/img/FWDaemonCheckPage.gif)](/template/static/img/FWDaemonCheckPage.gif "Click to see the full-resolution image")
...
[![Image DISPDAndFWDaemon.jpg](/template/static/img/DISPDAndFWDaemon.jpg)](/template/static/img/DISPDAndFWDaemon.jpg "Click to see the full-resolution image")
...
[![Image QACookieManager.gif](/template/static/img/QACookieManager.gif)](/template/static/img/QACookieManager.gif "Click to see the full-resolution image")
...
[![Image QA.jpg](/template/static/img/QA.jpg)](/template/static/img/QA.jpg "Click to see the full-resolution image")
...
[![Image NetCache\_diagramm.gif](/template/static/img/NetCache_diagramm.gif)](/template/static/img/NetCache_diagramm.gif "Click to see the full-resolution image")
